...
(function (Survey) {
    ...
    Survey.JsonObject.metaData.addClass("question", ["!name", "title", "isRequired", "visible", "validators", "width"]);
...
(function (Survey) {
    ...
    Survey.JsonObject.metaData.addClass("selectbase", ["hasComment", "hasOther", "!choices", "choicesOrder", "otherText", "otherErrorText"], null, "question");
...
(function (Survey) {
    ...
    Survey.JsonObject.metaData.addClass("rating", ["hasComment", "rateValues", "mininumRateDescription", "maximumRateDescription"], function () { return new QuestionRating(""); }, "question");
