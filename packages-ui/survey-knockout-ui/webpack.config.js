...
module.exports = function (options) {
    ...
    if (0 == percentage) {
      ...
      if (isProductionBuild) {
        dts.bundle({
          ...
          main: buildPath + "typings/entries/knockout-ui.d.ts",
  ...
  var config = {
    ...
    entry: {
      [packageJson.name]: path.resolve(__dirname, "../../src/entries/knockout-ui.ts"),
    },
    resolve: {
    ...
    output: {
      ...
      library: options.libraryName || "SurveyKnockout",
      libraryTarget: "umd",
      umdNamedDefine: true,
    },
    externals: {
