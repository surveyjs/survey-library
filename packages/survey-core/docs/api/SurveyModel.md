...
api-type: class
description: "The `SurveyModel` object contains properties and methods that allow you to control the survey and access its elements. [View Demo](https://surveyjs.io/form-library/examples/nps-question/ (linkStyle))"
source: 
---
...
### `progressTextModelValue`

**Type**: `SurveyProgressTextModel`

### `progressTextModel`

**Type**: `SurveyProgressTextModel`

### `navigationLayoutModelValue`

**Type**: `SurveyNavigationLayoutModel`

### `navigationLayoutModel`
...
### `isSettingValueOnExpression`

**Type**: `boolean`

### `renderedCompletedHtml`
...
### `createNavigationBarCallback`

**Type**: `() => ActionContainer<Action>`

### `_updateNavigationItemCssCallback`
...
### `onEditingObjPropertyChanged`

**Type**: `(sender: Base, options: any) => void`
...
### `valueHashGetDataCallback`

**Type**: `(valuesHash: any, key: string) => any`

### `valueHashSetDataCallback`

**Type**: `(valuesHash: any, key: string, value: any) => void`

### `valueHashDeleteDataCallback`

**Type**: `(valuesHash: any, key: string) => void`
...
### `isNavigationButtonsShowingOnTop`

**Type**: `boolean`

### `isNavigationButtonsShowingOnBottom`
...
### `isRunningElementsBindings`

**Type**: `boolean`

### `updateVisibleIndexAfterBindings`
...
### `conditionRunnerCounter`

**Type**: `number`

### `conditionUpdateVisibleIndexes`

**Type**: `boolean`

### `conditionNotifyElementsOnAnyValueOrVariableChanged`

**Type**: `boolean`

### `questionTriggersKeys`

**Type**: `any`

### `isRunningConditionOnValueChanged`
...
**Type**: `{ names: {}; namesInsensitive: {}; valueNames: {}; valueNamesInsensitive: {}; }`

### `textPreProcessorValue`

**Type**: `TextContextProcessor`
...
### `isTimerPanelShowingOnTop`

**Type**: `boolean`

### `isTimerPanelShowingOnBottom`
...
### `calculatedWidthModeUpdater`

**Type**: `ComputedUpdater<any>`
...
### `responsiveStartWidth`

**Type**: `number`

### `timerInfo`

**Type**: `{ spent: number; limit?: number; }`

### `timerClock`

**Type**: `{ majorText: string; minorText?: string; }`
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| `element` | `Question \| PanelModel \| SurveyModel \| PageModel` |  |
| `name` | `string` |  |
| `item` | `ItemValue` |  |
...
**Return value:** `PageModel[]<PageModel>`
...
**Return value:** `IFindElement[]<IFindElement>`
...
**Return value:** `ISurveyLayoutElement`
...
**Return value:** `ISurveyLayoutElement[]<ISurveyLayoutElement>`
