...
export var defaultCss = {
  ...
  panel: {
    ...
    titleExpandable: "sd-panel__title--expandable sd-element__title--expandable",
    titleExpandableSvgContainer: "sd-element__title-expandable-svg-container",
    titleExpandableSvg: "sd-panel__title-expandable-svg sd-element__title-expandable-svg",
    ...
    headerExpandable: "sd-panel__header--expandable sd-element__header--expandable",
    collapsed: "sd-panel--collapsed sd-element--collapsed",
    expanded: "sd-element--expanded",
    expandable: "sd-element--expandable",
    expandableAnimating: "sd-element--expandable-animating sd-panel--expandable-animating",
  ...
  paneldynamic: {
    ...
    header: "sd-paneldynamic__header sd-element__header sd-question__header sd-question__header--complex",
  ...
  progressButtonsTitlesInline: "sd-progress-buttons--titles-inline",
  ...
  question: {
    ...
    headerExpandable: "sd-question__header--expandable sd-element__header--expandable",
    ...
    title: "sd-title sd-element__title sd-question__title",
    titleExpandable: "sd-question__title--expandable sd-element__title--expandable",
    titleExpandableSvgContainer: "sd-element__title-expandable-svg-container",
    titleExpandableSvg: "sd-question__title-expandable-svg sd-element__title-expandable-svg",
    titleExpanded: "sd-element__title--expanded",
    titleCollapsed: "sd-element__title--collapsed",
    titleDisabled: "sd-element__title--disabled",
    ...
    collapsed: "sd-element--collapsed sd-question--collapsed",
    expandable: "sd-element--expandable",
    expandableAnimating: "sd-element--expandable-animating sd-question--expandable-animating",
    expanded: "sd-element--expanded",
  ...
  checkbox: {
    ...
    itemShortcut: "sd-item__shortcut",
    itemHasShortcut: "sd-item--shortcut",
  ...
  text: {
    ...
    hasMask: "sd-formbox__input--mask"
  },
  multipletext: {
    root: "sd-multipletext",
    rootMobile: "sd-multipletext--mobile",
    itemLabel: "sd-multipletext__item-container sd-formbox",
    itemLabelReadOnly: "sd-formbox--readonly",
    itemLabelDisabled: "sd-formbox--disabled",
    itemLabelPreview: "sd-formbox--preview",
    itemLabelOnError: "sd-formbox--error",
  ...
  imagepicker: {
    ...
    itemShortcut: "sd-imagepicker__shortcut",
    itemHasShortcut: "sd-imagepicker__item--shortcut",
  },
  matrix: {
    ...
    header: "sd-element__header sd-question__header sd-question__header--complex",
    ...
    body: "sd-table__body",
    bodyAlternativeRows: "sd-table__body--alternative-rows",
    rowError: "sd-matrix__row--error",
    cell: "sd-table__cell sd-matrix__cell",
    emptyCell: "sd-table__cell--empty",
    row: "sd-table__row sd-matrix__row sd-table__row--data",
  ...
  matrixdropdown: {
    ...
    row: "sd-table__row",
    errorRow: "sd-table__row--error",
    dataRow: "sd-table__row--data",
    ...
    detailPanelCell: "sd-table__cell sd-table__cell--detail-panel",
  ...
  matrixdynamic: {
    ...
    toolbar: "sd-matrixdynamic__toolbar",
    toolbarTop: "sd-matrixdynamic__toolbar--top",
    toolbarBottom: "sd-matrixdynamic__toolbar--bottom",
    footerTotalCell: "sd-table__cell sd-table__cell--footer-total",
  ...
  buttongroup: {
    ...
    itemControl: "sv-button-group__item-control sv-visuallyhidden",
    onError: "sd-formbox--error",
  ...
  tagbox: {
    ...
    cleanItemButtonSvg: "sd-tagbox-item__clean-button-svg",
