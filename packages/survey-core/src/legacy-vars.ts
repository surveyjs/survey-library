export const legacyCssVariables = {
  ...
  "--sjs-shadow-small-reset": "--sjs2-border-effect-surface-focused", //0px 0px 0px 0px rgba(0, 0, 0, 0.15)",
  ...
  "--sjs-shadow-inner-reset": "--sjs2-border-effect-form-formbox-focused", //inset 0px 0px 0px 0px rgba(0, 0, 0, 0.15)",
