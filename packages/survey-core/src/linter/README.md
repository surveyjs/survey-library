...
| `name/duplicate` | error | Two elements sharing a name in one namespace — survey elements, the columns of one matrix, the items of one multiple-text question; duplicate calculated-value names; a calculated value shadowing an element name. |
