...
export class Question extends SurveyElement<Question>
  ...
  // record or a table of its own is not a field - its children may be.
   ...
   */
  @property() useDisplayValuesInDynamicTexts: boolean;
  ...
  //#region singleInput - delegated to singleInputBehavior
  private _singleInputBehavior: QuestionSingleInputBehavior;
  public get singleInputBehavior(): QuestionSingleInputBehavior {
   ...
   * @see hasDescription
   */
  @property() descriptionLocation: string;
  ...
  focusInputElement(onError: boolean): void {
    ...
    const res = SurveyElement.FocusElement(id, false, surveyRoot, this.shouldHandleFocusScroll);
   ...
   */
  @property() clearIfInvisible: string;
   ...
   * @see resetValueIf
   */
  @property() setValueExpression: string;
   ...
   */
  @property({ onSetting: (val: any, obj: Question) => obj.valueToData(val) }) correctAnswer: any;
  /**
  ...
  */
  ...
  @property({ returnValue: false }) isAnswered: boolean;
