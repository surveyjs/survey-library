...
export default {
  ...
  "isPanelless": false,
  "cssVariables": {
    "--sjs2-color-bg-basic-primary": "rgba(255, 216, 77, 1)",
    "--sjs2-color-bg-basic-primary-dim": "rgba(255, 255, 255, 1)",
    "--sjs2-color-bg-neutral-tertiary-dim": "rgba(0, 0, 0, 1)",
    "--sjs2-color-utility-surface-survey": "rgba(0, 0, 0, 1)",
    "--sjs2-color-utility-surface-survey-panelless": "rgba(0, 0, 0, 1)",
    "--sjs2-color-bg-basic-secondary": "rgba(255, 255, 255, 1)",
    "--sjs2-color-bg-basic-secondary-dim": "rgba(255, 255, 255, 1)",
    ...
    "--sjs2-color-bg-brand-secondary": "rgba(255, 255, 255, 1)",
    "--sjs2-color-bg-brand-primary-dim": "rgba(53, 53, 53, 1)",
    ...
    "--sjs2-color-border-basic-secondary": "rgba(232, 192, 51, 1)",
