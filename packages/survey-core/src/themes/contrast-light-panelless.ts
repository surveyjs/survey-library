...
export default {
  ...
  "cssVariables": {
    ...
    "--sjs2-color-fg-basic-secondary": "rgba(from var(--sjs2-color-fg-basic-primary) r g b / var(--sjs2-opacity-x075))",
    "--sjs2-color-fg-basic-tertiary": "rgba(from var(--sjs2-color-fg-basic-primary) r g b / var(--sjs2-opacity-x055))",
    ...
    "--sjs2-color-border-basic-secondary": "var(--sjs2-palette-gray-300)",
    ...
    "--sjs2-color-component-radio-true-disabled-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-component-checkbox-true-disabled-border": "var(--sjs2-color-border-basic-secondary)",
