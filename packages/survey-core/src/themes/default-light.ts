...
export default {
  ...
  "cssVariables": {
    ...
    "--sjs2-radius-component-editor": "var(--sjs2-radius-semantic-form)",
    "--sjs2-radius-component-editor-item": "var(--sjs2-radius-semantic-form-item)",
    "--sjs2-radius-component-action": "var(--sjs2-radius-semantic-form)",
    "--sjs2-radius-component-action-icon": "var(--sjs2-radius-semantic-form)",
    "--sjs2-radius-component-button": "var(--sjs2-radius-semantic-form)",
    "--sjs2-radius-component-menu-item": "var(--sjs2-radius-semantic-form)",
    "--sjs2-radius-component-drop-item": "var(--sjs2-radius-x100)",
    "--sjs2-radius-component-checkbox": "var(--sjs2-radius-semantic-form-item)",
    ...
    "--sjs2-radius-component-drag": "var(--sjs2-radius-semantic-form)",
    "--sjs2-typography-font-family-semantic-text": "Open Sans",
    "--sjs2-typography-font-family-semantic-code": "DM Mono",
    "--sjs2-typography-font-family-component-editor-text": "Open Sans",
    ...
    "--sjs2-typography-font-size-semantic-small": "var(--sjs2-font-size-x150)",
    "--sjs2-typography-font-size-semantic-default": "var(--sjs2-font-size-x200)",
    "--sjs2-typography-font-size-semantic-medium": "var(--sjs2-font-size-x300)",
    "--sjs2-typography-font-size-semantic-large": "var(--sjs2-font-size-x400)",
    "--sjs2-typography-font-size-component-editor-text": "var(--sjs2-font-size-x200)",
    ...
    "--sjs2-typography-line-height-semantic-small": "var(--sjs2-line-height-x200)",
    "--sjs2-typography-line-height-semantic-default": "var(--sjs2-line-height-x300)",
    "--sjs2-typography-line-height-semantic-medium": "var(--sjs2-line-height-x400)",
    "--sjs2-typography-line-height-semantic-large": "var(--sjs2-line-height-x500)",
    "--sjs2-typography-line-height-component-editor-text": "var(--sjs2-line-height-x300)",
    ...
    "--sjs2-typography-font-weight-semantic-basic": "var(--sjs2-font-weight-regular)",
    "--sjs2-typography-font-weight-semantic-strong": "var(--sjs2-font-weight-semibold)",
    "--sjs2-typography-font-weight-component-editor-text": "var(--sjs2-font-weight-regular)",
    ...
    "--sjs2-color-control-editor-formbox-default-bg": "var(--sjs2-palette-gray-100)",
    "--sjs2-color-control-editor-formbox-default-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-control-editor-formbox-disabled-bg": "var(--sjs2-palette-gray-000)",
    "--sjs2-color-control-editor-formbox-disabled-border": "var(--sjs2-palette-gray-100)",
    "--sjs2-color-control-editor-formbox-readonly-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-editor-formbox-readonly-border": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-formbox-focused-bg": "var(--sjs2-palette-gray-100)",
    "--sjs2-color-control-editor-formbox-focused-border": "var(--sjs2-color-border-brand-primary)",
    "--sjs2-color-control-editor-formbox-invalid-bg": "var(--sjs2-palette-gray-100)",
    "--sjs2-color-control-editor-formbox-invalid-border": "var(--sjs2-color-border-alert-primary)",
    "--sjs2-color-control-editor-formbox-highlighted-bg": "var(--sjs2-palette-gray-100)",
    "--sjs2-color-control-editor-formbox-highlighted-border": "var(--sjs2-color-border-basic-primary)",
    "--sjs2-color-control-editor-formbox-design-bg": "var(--sjs2-palette-gray-100)",
    "--sjs2-color-control-editor-formbox-design-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-control-editor-formbox-hovered-bg": "var(--sjs2-palette-gray-100)",
    "--sjs2-color-control-editor-formbox-hovered-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-control-editor-input-default-line": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-control-editor-input-default-value": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-control-editor-input-default-placeholder": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-input-default-label": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-input-default-limit": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-input-default-icon": "var(--sjs2-color-fg-basic-tertiary)",
    "--sjs2-color-control-editor-input-default-description": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-input-disabled-line": "var(--sjs2-palette-gray-100)",
    "--sjs2-color-control-editor-input-disabled-value": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-input-disabled-placeholder": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-input-disabled-label": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-input-disabled-limit": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-input-disabled-icon": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-input-disabled-description": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-input-readonly-line": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-input-readonly-value": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-control-editor-input-readonly-placeholder": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-input-readonly-label": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-input-readonly-limit": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-input-readonly-icon": "var(--sjs2-color-fg-basic-tertiary)",
    "--sjs2-color-control-editor-input-readonly-description": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-segmented-false-default-bg": "rgba(from var(--sjs2-color-bg-basic-secondary) r g b / var(--sjs2-opacity-hidden))",
    "--sjs2-color-control-editor-segmented-false-default-border": "rgba(from var(--sjs2-color-border-basic-secondary) r g b / var(--sjs2-opacity-hidden))",
    "--sjs2-color-control-editor-segmented-false-default-value": "var(--sjs2-color-fg-basic-secondary)",
    "--sjs2-color-control-editor-segmented-false-disabled-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-editor-segmented-false-disabled-border": "rgba(from var(--sjs2-color-border-basic-secondary) r g b / var(--sjs2-opacity-hidden))",
    "--sjs2-color-control-editor-segmented-false-disabled-value": "var(--sjs2-palette-gray-250)",
    "--sjs2-color-control-editor-segmented-false-readonly-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-editor-segmented-false-readonly-border": "rgba(from var(--sjs2-color-border-basic-secondary) r g b / var(--sjs2-opacity-hidden))",
    "--sjs2-color-control-editor-segmented-false-readonly-value": "var(--sjs2-palette-gray-400)",
    "--sjs2-color-control-editor-segmented-false-focused-bg": "var(--sjs2-color-bg-basic-secondary)",
    "--sjs2-color-control-editor-segmented-false-focused-border": "var(--sjs2-color-border-brand-primary)",
    "--sjs2-color-control-editor-segmented-false-focused-value": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-control-editor-segmented-false-hovered-bg": "var(--sjs2-color-bg-basic-secondary-dim)",
    "--sjs2-color-control-editor-segmented-false-hovered-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-control-editor-segmented-false-hovered-value": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-control-editor-segmented-true-default-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-editor-segmented-true-default-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-control-editor-segmented-true-default-value": "var(--sjs2-color-fg-brand-primary)",
    "--sjs2-color-control-editor-segmented-true-disabled-bg": "var(--sjs2-color-bg-basic-primary-dim)",
    "--sjs2-color-control-editor-segmented-true-disabled-border": "rgba(from var(--sjs2-color-border-basic-secondary) r g b / var(--sjs2-opacity-hidden))",
    "--sjs2-color-control-editor-segmented-true-disabled-value": "var(--sjs2-palette-gray-400)",
    "--sjs2-color-control-editor-segmented-true-readonly-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-editor-segmented-true-readonly-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-control-editor-segmented-true-readonly-value": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-control-editor-segmented-true-focused-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-editor-segmented-true-focused-border": "var(--sjs2-color-border-brand-primary)",
    "--sjs2-color-control-editor-segmented-true-focused-value": "var(--sjs2-color-fg-brand-primary)",
    ...
    "--sjs2-color-control-panel-default-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-panel-default-border": "var(--sjs2-color-utility-shadow-surface-default)",
    "--sjs2-color-control-panel-hovered-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-panel-hovered-border": "var(--sjs2-color-utility-shadow-surface-hovered)",
    "--sjs2-color-control-panel-pressed-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-panel-pressed-border": "var(--sjs2-color-utility-shadow-surface-pressed)",
    "--sjs2-color-control-panel-focused-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-panel-focused-border": "var(--sjs2-color-utility-shadow-surface-focused)",
    "--sjs2-color-control-panel-disabled-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-panel-disabled-border": "var(--sjs2-color-utility-shadow-surface-disabled)",
    "--sjs2-color-control-panel-dragging-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-control-panel-dragging-border": "var(--sjs2-color-utility-shadow-surface-dragging)",
    ...
    "--sjs2-border-effect-form-formbox-default": "inset var(--sjs2-border-offset-x-form-default) var(--sjs2-border-offset-y-form-default) var(--sjs2-border-blur-form-default) var(--sjs2-border-spread-form-default) var(--sjs2-color-control-editor-formbox-default-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-hovered": "inset var(--sjs2-border-offset-x-form-hovered) var(--sjs2-border-offset-y-form-hovered) var(--sjs2-border-blur-form-hovered) var(--sjs2-border-spread-form-hovered) var(--sjs2-color-control-editor-formbox-hovered-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-focused": "inset var(--sjs2-border-offset-x-form-focused) var(--sjs2-border-offset-y-form-focused) var(--sjs2-border-blur-form-focused) var(--sjs2-border-spread-form-focused) var(--sjs2-color-control-editor-formbox-focused-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-disabled": "inset var(--sjs2-border-offset-x-form-disabled) var(--sjs2-border-offset-y-form-disabled) var(--sjs2-border-blur-form-disabled) var(--sjs2-border-spread-form-disabled) var(--sjs2-color-control-editor-formbox-disabled-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-invalid": "inset var(--sjs2-border-offset-x-form-invalid) var(--sjs2-border-offset-y-form-invalid) var(--sjs2-border-blur-form-invalid) var(--sjs2-border-spread-form-invalid) var(--sjs2-color-control-editor-formbox-invalid-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-highlighted": "inset var(--sjs2-border-offset-x-form-highlighted) var(--sjs2-border-offset-y-form-highlighted) var(--sjs2-border-blur-form-highlighted) var(--sjs2-border-spread-form-highlighted) var(--sjs2-color-control-editor-formbox-highlighted-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-readonly": "inset var(--sjs2-border-offset-x-form-readonly) var(--sjs2-border-offset-y-form-readonly) var(--sjs2-border-blur-form-readonly) var(--sjs2-border-spread-form-readonly) var(--sjs2-color-control-editor-formbox-readonly-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-design": "inset var(--sjs2-border-offset-x-form-design) var(--sjs2-border-offset-y-form-design) var(--sjs2-border-blur-form-design) var(--sjs2-border-spread-form-design) var(--sjs2-color-control-editor-formbox-design-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-check-false-default": "inset var(--sjs2-border-offset-x-form-default) var(--sjs2-border-offset-y-form-default) var(--sjs2-border-blur-form-default) var(--sjs2-border-spread-form-default) var(--sjs2-color-control-check-false-default-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-check-false-hovered": "inset var(--sjs2-border-offset-x-form-hovered) var(--sjs2-border-offset-y-form-hovered) var(--sjs2-border-blur-form-hovered) var(--sjs2-border-spread-form-hovered) var(--sjs2-color-control-check-false-hovered-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-check-false-disabled": "inset var(--sjs2-border-offset-x-form-disabled) var(--sjs2-border-offset-y-form-disabled) var(--sjs2-border-blur-form-disabled) var(--sjs2-border-spread-form-disabled) var(--sjs2-color-control-check-false-disabled-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-check-false-design": "inset var(--sjs2-border-offset-x-form-design) var(--sjs2-border-offset-y-form-design) var(--sjs2-border-blur-form-design) var(--sjs2-border-spread-form-design) var(--sjs2-color-control-check-false-design-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-check-true-default": "inset var(--sjs2-border-offset-x-form-default) var(--sjs2-border-offset-y-form-default) var(--sjs2-border-blur-form-default) var(--sjs2-border-spread-form-default) var(--sjs2-color-control-check-true-default-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-check-true-hovered": "inset var(--sjs2-border-offset-x-form-hovered) var(--sjs2-border-offset-y-form-hovered) var(--sjs2-border-blur-form-hovered) var(--sjs2-border-spread-form-hovered) var(--sjs2-color-control-check-true-hovered-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-check-true-disabled": "inset var(--sjs2-border-offset-x-form-disabled) var(--sjs2-border-offset-y-form-disabled) var(--sjs2-border-blur-form-disabled) var(--sjs2-border-spread-form-disabled) var(--sjs2-color-control-check-true-disabled-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-toggle-false-default": "inset var(--sjs2-border-offset-x-form-default) var(--sjs2-border-offset-y-form-default) var(--sjs2-border-blur-form-default) var(--sjs2-border-spread-form-default) var(--sjs2-color-control-toggle-false-default-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-toggle-false-hovered": "inset var(--sjs2-border-offset-x-form-hovered) var(--sjs2-border-offset-y-form-hovered) var(--sjs2-border-blur-form-hovered) var(--sjs2-border-spread-form-hovered) var(--sjs2-color-control-toggle-false-hovered-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-toggle-false-disabled": "inset var(--sjs2-border-offset-x-form-disabled) var(--sjs2-border-offset-y-form-disabled) var(--sjs2-border-blur-form-disabled) var(--sjs2-border-spread-form-disabled) var(--sjs2-color-control-toggle-false-disabled-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-toggle-true-default": "inset var(--sjs2-border-offset-x-form-default) var(--sjs2-border-offset-y-form-default) var(--sjs2-border-blur-form-default) var(--sjs2-border-spread-form-default) var(--sjs2-color-control-toggle-true-default-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-toggle-true-hovered": "inset var(--sjs2-border-offset-x-form-hovered) var(--sjs2-border-offset-y-form-hovered) var(--sjs2-border-blur-form-hovered) var(--sjs2-border-spread-form-hovered) var(--sjs2-color-control-toggle-true-hovered-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-toggle-true-disabled": "inset var(--sjs2-border-offset-x-form-disabled) var(--sjs2-border-offset-y-form-disabled) var(--sjs2-border-blur-form-disabled) var(--sjs2-border-spread-form-disabled) var(--sjs2-color-control-toggle-true-disabled-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
