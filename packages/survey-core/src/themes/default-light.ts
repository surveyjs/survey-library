...
export default {
  ...
  "cssVariables": {
    ...
    "--sjs2-border-effect-form-formbox-focused": "inset var(--sjs2-border-offset-x-form-focused) var(--sjs2-border-offset-y-form-focused) var(--sjs2-border-blur-form-focused) var(--sjs2-border-spread-form-focused) var(--sjs2-color-control-formbox-focused-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-disabled": "inset var(--sjs2-border-offset-x-form-disabled) var(--sjs2-border-offset-y-form-disabled) var(--sjs2-border-blur-form-disabled) var(--sjs2-border-spread-form-disabled) var(--sjs2-color-control-formbox-disabled-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-invalid": "inset var(--sjs2-border-offset-x-form-invalid) var(--sjs2-border-offset-y-form-invalid) var(--sjs2-border-blur-form-invalid) var(--sjs2-border-spread-form-invalid) var(--sjs2-color-control-formbox-invalid-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-highlighted": "inset var(--sjs2-border-offset-x-form-highlighted) var(--sjs2-border-offset-y-form-highlighted) var(--sjs2-border-blur-form-highlighted) var(--sjs2-border-spread-form-highlighted) var(--sjs2-color-control-formbox-highlighted-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-readonly": "inset var(--sjs2-border-offset-x-form-readonly) var(--sjs2-border-offset-y-form-readonly) var(--sjs2-border-blur-form-readonly) var(--sjs2-border-spread-form-readonly) var(--sjs2-color-control-formbox-readonly-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
    "--sjs2-border-effect-form-formbox-design": "inset var(--sjs2-border-offset-x-form-design) var(--sjs2-border-offset-y-form-design) var(--sjs2-border-blur-form-design) var(--sjs2-border-spread-form-design) var(--sjs2-color-control-formbox-design-border), inset 0px 0px 0px 0px rgba(0,0,0,0)",
