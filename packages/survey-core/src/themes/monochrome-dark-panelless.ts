...
export default {
  ...
  "cssVariables": {
    ...
    "--sjs2-color-component-formbox-focused-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-formbox-invalid-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-formbox-highlighted-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-formbox-design-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-formbox-hovered-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-formbox-invalid-focused-bg": "var(--sjs2-color-bg-basic-primary)",
    ...
    "--sjs2-color-component-radio-false-default-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-radio-false-hovered-bg": "var(--sjs2-color-bg-basic-primary-dim)",
    "--sjs2-color-component-radio-false-design-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-radio-false-invalid-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-radio-true-default-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-radio-true-default-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-component-radio-true-default-icon": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-component-radio-true-hovered-bg": "var(--sjs2-color-bg-basic-primary-dim)",
    "--sjs2-color-component-radio-true-hovered-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-component-radio-true-hovered-icon": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-component-checkbox-false-default-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-checkbox-false-hovered-bg": "var(--sjs2-color-bg-basic-primary-dim)",
    "--sjs2-color-component-checkbox-false-design-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-checkbox-false-invalid-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-checkbox-true-default-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-checkbox-true-default-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-component-checkbox-true-default-icon": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-component-checkbox-true-hovered-bg": "var(--sjs2-color-bg-basic-primary-dim)",
    "--sjs2-color-component-checkbox-true-hovered-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-component-checkbox-true-hovered-icon": "var(--sjs2-color-fg-basic-primary)",
