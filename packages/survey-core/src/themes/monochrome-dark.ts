...
export default {
  ...
  "cssVariables": {
    ...
    "--sjs2-color-component-check-false-invalid-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-check-true-default-bg": "var(--sjs2-color-bg-basic-primary)",
    "--sjs2-color-component-check-true-default-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-component-check-true-default-icon": "var(--sjs2-color-fg-basic-primary)",
    "--sjs2-color-component-check-true-hovered-bg": "var(--sjs2-color-bg-basic-primary-dim)",
    "--sjs2-color-component-check-true-hovered-border": "var(--sjs2-color-border-basic-secondary)",
    "--sjs2-color-component-check-true-hovered-icon": "var(--sjs2-color-fg-basic-primary)",
