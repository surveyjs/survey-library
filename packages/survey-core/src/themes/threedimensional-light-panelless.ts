...
export default {
  ...
  "cssVariables": {
    ...
    "--sjs2-border-effect-component-formbox-default": "0px 0px 0px 2 rgba(228, 228, 228, 1), 0px -2 0px 2 rgba(228, 228, 228, 1)",
    "--sjs2-border-effect-surface-default": "0px 2 0px 2 rgba(228, 228, 228, 1), 0px 0px 0px 2 rgba(228, 228, 228, 1)",
    "--sjs2-border-effect-floating-default": "0px 0px 0px 2 rgba(228, 228, 228, 1), 0px 8 0px 2 rgba(228, 228, 228, 1), 0px 0px 0px 0px rgba(0, 0, 0, 0.1)"
  }
};
