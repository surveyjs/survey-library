...
import { getSurveyString } from "../src/surveyStrings";
...
QUnit.test("Writable captions", function (assert) {
   ...
   */
  assert.equal(q.confirmRemoveMessage, getSurveyString("confirmRemoveFile"), "The remove file confirmation message template default");
  q.confirmRemoveMessage += "_new";
  assert.equal(q.confirmRemoveMessage, getSurveyString("confirmRemoveFile") + "_new", "The remove file confirmation message template new");
  /**
    * The remove all files confirmation message.
    */
  assert.equal(q.confirmRemoveAllMessage, getSurveyString("confirmRemoveAllFiles"), "The remove all files confirmation message default");
  q.confirmRemoveAllMessage += "_new";
  assert.equal(q.confirmRemoveAllMessage, getSurveyString("confirmRemoveAllFiles") + "_new", "The remove all files confirmation message new");
  /**
    * The no file chosen caption for modern theme.
    */
  assert.equal(q.noFileChosenCaption, getSurveyString("noFileChosen"), "The no file chosen caption for modern theme default");
  q.noFileChosenCaption += "_new";
  assert.equal(q.noFileChosenCaption, getSurveyString("noFileChosen") + "_new", "The no file chosen caption for modern theme new");
  /**
    * The choose files button caption for modern theme.
    */
  assert.equal(q.chooseButtonCaption, getSurveyString("chooseFileCaption"), "The choose files button caption for modern theme default");
  q.chooseButtonCaption += "_new";
  assert.equal(q.chooseButtonCaption, getSurveyString("chooseFileCaption") + "_new", "The choose files button caption for modern theme new");
  /**
    * The clean files button caption.
    */
  assert.equal(q.clearButtonCaption, getSurveyString("clearCaption"), "The clean files button caption default");
  q.clearButtonCaption += "_new";
  assert.equal(q.clearButtonCaption, getSurveyString("clearCaption") + "_new", "The clean files button caption new");
  /**
    * The remove file button caption.
    */
  assert.equal(q.removeFileCaption, getSurveyString("removeFileCaption"), "The remove file button caption default");
  q.removeFileCaption += "_new";
  assert.equal(q.removeFileCaption, getSurveyString("removeFileCaption") + "_new", "The remove file button caption new");
  /**
    * The loading file input title.
    */
  assert.equal(q.loadingFileTitle, getSurveyString("loadingFile"), "The loading file input title default");
  q.loadingFileTitle += "_new";
  assert.equal(q.loadingFileTitle, getSurveyString("loadingFile") + "_new", "The loading file input title new");
  /**
   * The choose file input title.
   */
  assert.equal(q.chooseFileTitle, getSurveyString("chooseFile"), "The choose file input title default");
  q.chooseFileTitle += "_new";
  assert.equal(q.chooseFileTitle, getSurveyString("chooseFile") + "_new", "The choose file input title new");
