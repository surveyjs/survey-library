...
describe("SurveyStateTest", () => {
  ...
  test("restore active element in dynamic panel", () => {
    ...
    expect(survey.uiState, "survey state with last active").toEqual({ pages: { page1: { shown: true }, page2: { shown: true } }, questions: { q4: { activePanelIndex: 1 } }, activeElementName: "q4" });
