...
describe("SurveyTimer", () => {
  ...
  test("Showing prev button, showTimerInfo='all'", () => {
    ...
    expect(survey.timerClock, "timerClock #5").toEqual({ majorText: "0:55", minorText: "0:03" });
    ...
    expect(survey.timerClock, "timerClock #6").toEqual({ majorText: "0:57", minorText: "0:55" });
    survey.timeLimit = 0;
  ...
  test("syrvey.timerClock, no negative value", () => {
    ...
    survey.startTimer();
    expect(survey.timerClock, "timerClock #1").toEqual({ majorText: "0:50", minorText: "1:00" });
    survey.timeSpent = 20;
    survey.currentPage.timeSpent = 20;
    expect(survey.timerClock, "timerClock #2").toEqual({ majorText: "0:30", minorText: "0:40" });
    survey.timeSpent = 60;
    survey.currentPage.timeSpent = 60;
    expect(survey.timerClock, "timerClock #3").toEqual({ majorText: "0:00", minorText: "0:00" });
    survey.timeSpent = 600;
    survey.currentPage.timeSpent = 600;
    expect(survey.timerClock, "timerClock #4").toEqual({ majorText: "0:00", minorText: "0:00" });
    survey.stopTimer();
  });
