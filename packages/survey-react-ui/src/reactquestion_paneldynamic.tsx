  ...
  protected renderElement(): React.JSX.Element {
    ...
    return (
      <div className={this.question.cssClasses.root}>
        {this.question.hasTabbedMenu ? <div className={this.question.cssClasses.tabsContainer}><SurveyActionBar model={this.question.tabbedMenu}></SurveyActionBar></div> : null }
