  ...
  test.describe(`${framework} ${title}`, () => {
    ...
    test("Matrix many columns", async ({ page }) => {
      ...
      await page.evaluate(() => {
        (window as any).survey.applyTheme({
          "cssVariables": {
            "--sjs2-color-utility-surface-survey": "blue",
            "--sjs2-color-component-panel-default-bg": "blue",
          }
        }, (window as any).SurveyTheme.DefaultLightPanelless);
      });
