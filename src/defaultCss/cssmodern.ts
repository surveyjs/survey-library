...
export var modernCss = {
  ...
  matrix: {
    ...
    labelRadio: "sv-item sv-radio sv-matrix__label",
    labelCheckbox: "sv-item sv-checkbox sv-matrix__label",
    itemValue: "sv-visuallyhidden sv-item__control",
    itemChecked: "sv-radio--checked",
    itemRadioChecked: "sv-radio--checked",
    itemCheckboxChecked: "sv-checkbox--checked",
    itemDisabled: "sv-item--disabled sv-radio--disabled",
    itemRadioDisabled: "sv-item--disabled sv-radio--disabled",
    itemCheckboxDisabled: "sv-item--disabled sv-checkbox--disabled",
    itemHover: "sv-radio--allowhover",
    itemRadioHover: "sv-radio--allowhover",
    itemCheckboxHover: "sv-checkbox--allowhover",
    materialDecorator: "sv-item__decorator  sv-radio__decorator",
    checkboxMaterialDecorator: "sv-item__decorator  sv-checkbox__decorator",
    itemDecorator: "sv-item__svg radio__svg",
    itemcheckboxDecorator: "sv-item__svg checkbox__svg",
