...
export var defaultV2Css = {
  ...
  panel: {
    ...
    contentFadeOutActive: "sd-element__content--fade-out",
    contentFadeOut: "sd-hidden",
    expandable: "sd-element--expandable",
    fadeIn: "sd-element-wrapper--fade-in",
    fadeOutActive: "sd-element-wrapper--fade-out",
    fadeOut: "sd-hidden",
  ...
  rowFadeOutActive: "sd-row--fade-out",
  rowFadeOut: "sd-hidden",
