...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c18 = function(): any { return "lessorequal"; };
  const peg$c19 = ">=";
  ...
  const peg$c25 = function(): any { return "greaterorequal"; };
  const peg$c26 = "==";
  ...
  const peg$c34 = function(): any { return "equal"; };
  const peg$c35 = "!=";
  ...
  const peg$c80 = function(): any { return "contains"; };
  ...
  const peg$c85 = function(): any { return "notcontains"; };
  const peg$c86 = "anyof";
  const peg$c87 = peg$literalExpectation("anyof", true);
  const peg$c88 = function(): any {return "anyof"; };
  const peg$c89 = "allof";
  const peg$c90 = peg$literalExpectation("allof", true);
  const peg$c91 = function(): any {return "allof"; };
  const peg$c92 = "(";
  const peg$c93 = peg$literalExpectation("(", false);
  const peg$c94 = ")";
  const peg$c95 = peg$literalExpectation(")", false);
  const peg$c96 = function(expr: any): any { return expr; };
  const peg$c97 = function(name: any, params: any): any { return new FunctionOperand(name, params); };
  const peg$c98 = "!";
  const peg$c99 = peg$literalExpectation("!", false);
  const peg$c100 = "negate";
  const peg$c101 = peg$literalExpectation("negate", true);
  const peg$c102 = function(expr: any): any { return new UnaryOperand(expr, "negate"); };
  const peg$c103 = function(expr: any, op: any): any { return new UnaryOperand(expr, op); };
  const peg$c104 = "empty";
  const peg$c105 = peg$literalExpectation("empty", true);
  const peg$c106 = function(): any { return "empty"; };
  const peg$c107 = "notempty";
  const peg$c108 = peg$literalExpectation("notempty", true);
  const peg$c109 = function(): any { return "notempty"; };
  const peg$c110 = "undefined";
  const peg$c111 = peg$literalExpectation("undefined", false);
  const peg$c112 = "null";
  const peg$c113 = peg$literalExpectation("null", false);
  const peg$c114 = function(): any { return null; };
  const peg$c115 = function(value: any): any { return new Const(value); };
  const peg$c116 = "{";
  const peg$c117 = peg$literalExpectation("{", false);
  const peg$c118 = "}";
  const peg$c119 = peg$literalExpectation("}", false);
  const peg$c120 = function(value: any): any { return new Variable(value); };
  const peg$c121 = "'";
  ...
  const peg$c130 = function(sequence: any): any { return sequence; };
  const peg$c131 = ",";
  const peg$c132 = peg$literalExpectation(",", false);
  const peg$c133 = function(expr: any, tail: any): any {
      if (expr == null)
        return [];
  ...
  const peg$c134 = "true";
  const peg$c135 = peg$literalExpectation("true", true);
  const peg$c136 = function(): any { return true; };
  const peg$c137 = "false";
  const peg$c138 = peg$literalExpectation("false", true);
  const peg$c139 = function(): any { return false; };
  const peg$c140 = "0x";
  const peg$c141 = peg$literalExpectation("0x", false);
  const peg$c142 = function(): any { return parseInt(text(), 16); };
  const peg$c143 = /^[\-]/;
  const peg$c144 = peg$classExpectation(["-"], false, false);
  const peg$c145 = function(sign: any, num: any): any { return sign == null ? num : -num; };
  const peg$c146 = ".";
  const peg$c147 = peg$literalExpectation(".", false);
  const peg$c148 = function(): any { return parseFloat(text()); };
  const peg$c149 = function(): any { return parseInt(text(), 10); };
  const peg$c150 = "0";
  const peg$c151 = peg$literalExpectation("0", false);
  const peg$c152 = function(): any { return 0; };
  const peg$c153 = function(chars: any): any { return chars.join(""); };
  const peg$c154 = "\\'";
  const peg$c155 = peg$literalExpectation("\\'", false);
  const peg$c156 = function(): any { return "'"; };
  const peg$c157 = "\\\"";
  const peg$c158 = peg$literalExpectation("\\\"", false);
  const peg$c159 = function(): any { return "\""; };
  const peg$c160 = /^[^"'{}]/;
  const peg$c161 = peg$classExpectation(["\"", "'", "{", "}"], true, false);
  const peg$c162 = function(): any { return text(); };
  const peg$c163 = /^[0-9]/;
  const peg$c164 = peg$classExpectation([["0", "9"]], false, false);
  const peg$c165 = /^[1-9]/;
  const peg$c166 = peg$classExpectation([["1", "9"]], false, false);
  const peg$c167 = /^[a-zA-Z]/;
  const peg$c168 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false);
  ...
  function peg$parseComparableOperators(): any {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s1 === peg$FAILED) {
        ...
        if (s1 === peg$FAILED) {
          if (input.substr(peg$currPos, 14).toLowerCase() === peg$c23) {
