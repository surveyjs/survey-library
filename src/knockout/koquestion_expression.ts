...
export class QuestionExpressionImplementor extends QuestionImplementor {
    ...
    constructor(public question: Question) {
        ...
        this.question["koDisplayValue"] = this.koDisplayValue;
    }
...
JsonObject.metaData.overrideClassCreatore("expression", function () { return new QuestionExpression(""); });
QuestionFactory.Instance.registerQuestion("expression", (name) => { return new QuestionExpression(name); });
