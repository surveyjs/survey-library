...
export var englishStrings = {
  ...
  urlRequestError: "A network service has returned the following error '{0}'. {1}",
  urlGetChoicesError:
    "A network service has returned invalid data",
  exceedMaxSize: "The file size should not exceed {0}.",
  otherRequiredError: "Please enter a value.",
  uploadingFile:
  ...
  cleanCaption: "Delete All",
  clearCaption: "Deselect All",
  chooseFileCaption: "Choose file",
  removeFileCaption: "Remove file",
