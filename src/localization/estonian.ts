...
export var estonianSurveyStrings = {
  ...
  completingSurveyBefore:
    "Meie andmetel oled sellele ankeedile juba vastanud.",
  ...
  textMinMaxLength: "Sisesta palun {0} kuni {1} tähemärki.",
  ...
  keyDuplicationError: "See väärtus peaks olema unikaalne.",
