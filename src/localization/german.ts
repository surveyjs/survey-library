...
export var germanSurveyStrings = {
  ...
  emptySurvey: "Es gibt keine Frage im Fragebogen.",
  ...
  minSelectError: "Bitte wählen Sie mindestens {0} Varianten aus.",
  maxSelectError: "Bitte wählen Sie nicht mehr als {0} Varianten aus.",
  numericMinMax:
