...
export class QuestionDateImplementor extends QuestionImplementor {
    ...
    private get inputId() { return "date_" + this.question.id; }
}
...
JsonObject.metaData.overrideClassCreatore("date", function () { return new QuestionDate(""); });
QuestionFactory.Instance.registerQuestion("date", (name) => { return new QuestionDate(name); });
