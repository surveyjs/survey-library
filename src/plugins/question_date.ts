...
JsonObject.metaData.addClass("date", //"date" - question type identificator
    ...
    ["showOtherMonths:boolean", "selectOtherMonths:boolean", "showButtonPanel:boolean",
        "changeMonth:boolean", "changeYear:boolean", { name: "numberOfMonths", default: 1, choices: [1, 2, 3, 4, 5] }, "minDate", "maxDate"],
    //json deserializer will call this function to create the object
    function () { return new QuestionDateModel(""); },
...
QuestionFactory.Instance.registerQuestion("date", (name) => { return new QuestionDateModel(name); });
