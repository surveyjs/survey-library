...
export class QuestionHtmlModel extends QuestionBase {
    ...
    public get html(): string { return this.getLocalizableStringText("html", ""); }
    public set html(val: string) { this.setLocalizableStringText("html", val); }
    get locHtml(): LocalizableString { return this.getLocalizableString("html"); }
