...
export class QuestionRatingModel extends Question {
     ...
     * @see rateStep
     */
    public get rateMin(): number { return this.getPropertyValue("rateMin", 1); }
    ...
    * @see rateStep
     */
    public get rateMax(): number { return this.getPropertyValue("rateMax", 5); }
    ...
    * @see rateMax
     */
    public get rateStep(): number { return this.getPropertyValue("rateStep", 1); }
     ...
     */
    public get minRateDescription(): string { return this.getLocalizableStringText("minRateDescription"); }
    public set minRateDescription(val: string) { this.setLocalizableStringText("minRateDescription", val); }
    get locMinRateDescription(): LocalizableString {return this.getLocalizableString("minRateDescription"); }
    /**
     * The description of maximum (last) item.
     */
    public get maxRateDescription(): string { return this.getLocalizableStringText("maxRateDescription");}
    public set maxRateDescription(val: string) { this.setLocalizableStringText("maxRateDescription", val); }
    get locMaxRateDescription(): LocalizableString {return this.getLocalizableString("maxRateDescription"); };
}
