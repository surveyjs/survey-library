...
export class SurveyNavigation extends SurveyNavigationBase {
    ...
    render(): JSX.Element {
        ...
        var prevButton = !this.survey.isFirstPage && this.survey.isShowPrevButton ? this.renderButton(this.handlePrevClick, this.survey.pagePrevText, this.css.navigation.prev) : null;
