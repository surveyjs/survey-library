...
export class SurveyProgress extends SurveyNavigationBase {
    ...
    render(): JSX.Element {
        ...
        return (<div className={this.css.progress} >
            <div className={this.css.progressBar} role="progressbar" aria-valuemin="0" aria-valuemax="100">
                <span className='progress-meter' style={progressStyle}>
                    <span className="progress-meter-text">{this.progressText}</span>
                </span>
                </div>
            </div>);
    }
