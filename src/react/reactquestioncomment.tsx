...
export class SurveyQuestionComment extends SurveyQuestionElementBase {
    ...
    render(): JSX.Element {
        ...
        if (this.isDisplayMode)
            return (<div id={this.question.inputId} className={this.css.comment}>{this.question.value}</div>)
        return (
            <textarea id={this.question.inputId} className={this.css.comment} type="text" value={this.state.value} placeholder={this.question.placeHolder} onBlur={this.handleOnBlur} onChange={this.handleOnChange} cols={this.question.cols} rows={this.question.rows} />
        );
    }
}
