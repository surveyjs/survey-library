...
export class SurveyQuestionExpression extends SurveyQuestionElementBase {
    ...
    protected get question(): QuestionExpressionModel { return this.questionBase as QuestionExpressionModel; }
    ...
    render(): JSX.Element {
        ...
        return (<div id={this.question.inputId} className={cssClasses.root}>{this.question.displayValue}</div>);
    }
}
