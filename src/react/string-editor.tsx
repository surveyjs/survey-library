...
export class SurveyLocStringEditor extends React.Component<any, any> {
    ...
    render(): JSX.Element {
      ...
      if (this.locStr.hasHtml) {
        ...
        return <span className="sv-string-editor" contentEditable="true" style={this.style} dangerouslySetInnerHTML={htmlValue} onBlur={ this.onInput } onClick={ this.onClick } />;
      }
      return <span className="sv-string-editor" contentEditable="true" style={this.style} onBlur={ this.onInput } onClick={ this.onClick }>{this.locStr.renderedHtml}</span>;
    }
  }
