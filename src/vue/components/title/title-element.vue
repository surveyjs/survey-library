<template>
  <component v-if="element.hasTitle"
    ...
    "
  >
  <survey-element-title-content v-if="!element.hasTitleActions" :element="element" :css="css"></survey-element-title-content>
  <sv-title-actions v-if="element.hasTitleActions" :element="element" :css="css"></sv-title-actions>
  </component>
</template>
