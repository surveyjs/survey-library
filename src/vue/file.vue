<template>
    <div :class="question.cssClasses.root">
        ...
        <div v-if="hasValue">
            <img v-for="val in question.previewValue" :key="val" v-show="val" :class="question.cssClasses.preview" :src="val" :height="question.imageHeight" :width="question.imageWidth" alt="File preview"/>
        </div>
    </div>
</template>
