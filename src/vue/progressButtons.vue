<template>
  <div :class="css.progressButtonsContainerCenter">
      <div :class="css.progressButtonsContainer">
          ...
          <div :class="getScrollButtonCss(hasScroller, false)" v-on:click="clickScrollButton(false)" role="button"></div>
      </div>
  </div>
</template>
...
export class ProgressButtons extends Vue {
  ...
  public getScrollButtonCss(hasScroller: boolean, isLeftScroll: boolean): any {
    ...
    if (!hasScroller) scrollCss += " " + this.css.progressButtonsImageButtonHidden;
    return scrollCss;
  }
