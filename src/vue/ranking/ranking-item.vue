      ...
      <div class="sv-ranking-item__content">
        <div class="sv-ranking-item__icon-container">
          <svg
            ...
            viewBox="0 0 10 16"
            fill="#19B394"
            class="sv-ranking-item__icon sv-ranking-item__hover-icon"
          ...
          <svg
            ...
            viewBox="0 0 10 24"
            fill="#19B394"
            class="sv-ranking-item__icon sv-ranking-item__focus-icon"
            xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="sv-ranking-item__index">{{index + 1}}</div>
        <div class="sv-ranking-item__text">{{text}}</div>
      </div>
    </div>
  </div>
</template>
