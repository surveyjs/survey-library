      ...
      render: function(questionBase) {
        ...
        let items = questionBase.visibleChoices.map((item, index) =>
          React.createElement(
            ...
            React.createElement('div', { style: itemStyle }, item.text)
          )
        )
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('span', null, 'move items here')
          ),
          React.createElement(
            'div',
        ...
        question.visibleChoices.forEach(function(choice) {
          $source.append(
            `<div data-value="` +
              choice.value +
              `">
                               <div style="background-color:#1ab394;color:#fff;margin:5px;padding:10px;">` +
              choice.text +
              `</div>
                             </div>`
          )
