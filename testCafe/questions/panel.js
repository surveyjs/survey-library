...
frameworks.forEach( (framework) => {
    ...
    test(`titles and margins`, async t => {
        let surveyResult;
        const getTitle1 = Selector(() =>
            document.querySelectorAll("div"), { text: "question1", visibilityCheck: true, timeout: 1000});
        const getTitle2 = Selector(() =>
            document.querySelectorAll("div"), { text: "question2", visibilityCheck: true, timeout: 1000});
        const getTitle3 = Selector(() =>
            document.querySelectorAll("div"), { text: "question3", visibilityCheck: true, timeout: 1000});
        const getTitle4 = Selector(() =>
