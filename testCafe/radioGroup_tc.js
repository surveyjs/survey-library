...
fixture `Test Radiogroup question`
    .page('http://surveyjs.org/examples/questiontype-radiogroup.html');
...
test('Check requre and set value test', async t => {
    ...
    assert.equal(divError.offsetParent, null, 'The error is hidden');
    await t 
