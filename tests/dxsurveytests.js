...
(function (dxSurvey) {
    ...
    (function (Tests) {
        ...
        QUnit.test("Add two pages", function (assert) {
            ...
            survey.addPage(new dxSurvey.Page("Page 2"));
        ...
        QUnit.test("Question Creator", function (assert) {
            ...
            inst.registerQuestion("question1", function (name) { return new dxSurvey.Question(name); });
            inst.registerQuestion("question2", function (name) { return new dxSurvey.Question(name); });
